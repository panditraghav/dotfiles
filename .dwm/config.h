...
static const char *fonts[]          = {"JetBrains Mono Nerd Font:size=10", "monospace:size=10" };
...
static const char col_brown[]	    = "#2f1d0f";
static const char col_border[]      = "#70411d";
static const char col_light1[]	    = "#e5ddca";

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_light1, col_brown,  col_gray2  },
	[SchemeSel]  = { col_gray4, col_brown,  col_border },
};
